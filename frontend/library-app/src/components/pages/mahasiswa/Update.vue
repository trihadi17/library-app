                ...
                <div class="col-12">
                  <form @submit.prevent="onSubmit">
                    ...
                    <div class="form-group mb-2">
                      ...
                      <select
                        v-model="student.status_mahasiswa"
                        class="form-control"
                      >
...
export default {
  ...
  methods: {
    loadData() {
      //* Get Data
      this.axios
        .get(`http://localhost:3000/student/${this.$route.params.id}`)
        .then((response) => {
    ...
    onSubmit() {
      this.axios
        .patch(
          `http://localhost:3000/student/${this.$route.params.id}`,
          this.student
        )
        .then((response) => {
